            ...
            <div className="automotive-card p-8 md:p-12">
                {success ? (
                  <div className="text-center">
                    ...
                    <h2 className="text-3xl font-bold theme-text-primary mb-2">Account Created!</h2>
                    <p className="text-base theme-text-secondary mb-2">Welcome to TechTorque Auto, {formData.fullName}!</p>
                    <p className="text-sm theme-text-muted">A verification email has been sent to {formData.email}. Please verify your email to log in.</p>
                  ...
                  <>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="theme-form-group">
                             <label htmlFor="fullName" className="block text-sm font-semibold theme-text-secondary mb-2">
                                Full Name
                            </label>
                            <input
                                id="fullName"
                        ...
                        <div className="theme-form-group">
                             <label htmlFor="phone" className="block text-sm font-semibold theme-text-secondary mb-2">
                                Phone Number
                            </label>
                            <input
                                id="phone"
                        ...
                        <div className="theme-form-group">
                             <label htmlFor="address" className="block text-sm font-semibold theme-text-secondary mb-2">
                                Address
                            </label>
                            <input
                                id="address"
                        ...
                        <div className="theme-form-group">
                             <div className="flex justify-between items-center mb-2">
                               <label htmlFor="password" className="block text-sm font-semibold theme-text-secondary">
                                  Password
                                </label>
                                <button
                                  type="button"
                        ...
                        <div className="theme-form-group">
                             <div className="flex justify-between items-center mb-2">
                               <label htmlFor="confirmPassword" className="block text-sm font-semibold theme-text-secondary">
                                  Confirm Password
                                </label>
                                <button
                                  type="button"
                ...
                <p className="mt-8 text-center text-sm theme-text-muted">
                    ...
                    <Link href="/auth/login" className="font-semibold theme-link hover:underline">
                        Sign in
                    </Link>
                </p>
            </div>
