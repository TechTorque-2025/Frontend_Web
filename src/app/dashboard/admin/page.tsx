      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="animate-pulse space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="h-32 theme-bg-tertiary rounded-lg"></div>
            ))}
          </div>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Link
          ...
          className="dashboard-content-card hover:border-blue-400 dark:hover:border-blue-500 transition-all hover:shadow-lg group"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
              <svg className="w-6 h-6 text-blue-700 dark:text-blue-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          ...
          className="dashboard-content-card hover:border-green-400 dark:hover:border-green-500 transition-all hover:shadow-lg group"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center group-hover:bg-green-600 transition-colors">
              <svg className="w-6 h-6 text-green-700 dark:text-green-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          ...
          className="dashboard-content-card hover:border-purple-400 dark:hover:border-purple-500 transition-all hover:shadow-lg group"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center group-hover:bg-purple-600 transition-colors">
              <svg className="w-6 h-6 text-purple-700 dark:text-purple-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          ...
          className="dashboard-content-card hover:border-amber-400 dark:hover:border-amber-500 transition-all hover:shadow-lg group"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center group-hover:bg-amber-600 transition-colors">
              <svg className="w-6 h-6 text-amber-700 dark:text-amber-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {stats && (
        <>
          <div className="mb-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="stat-card">
                ...
                <p className="stat-card-value">{stats.totalCustomers ?? 0}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Total employees</p>
                <p className="stat-card-value">{stats.totalEmployees ?? 0}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Total vehicles</p>
                <p className="stat-card-value">{stats.totalVehicles ?? 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="stat-card">
                <p className="stat-card-label">Active appointments</p>
                <p className="stat-card-value">{stats.activeAppointments ?? 0}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Completed (month)</p>
                <p className="stat-card-value text-green-600 dark:text-green-400">{stats.completedServicesThisMonth ?? 0}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Active projects</p>
                <p className="stat-card-value text-purple-600 dark:text-purple-400">{stats.activeProjects ?? 0}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Pending invoices</p>
                <p className="stat-card-value text-amber-600 dark:text-amber-400">{stats.pendingInvoices ?? 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="stat-card">
                <p className="stat-card-label">Revenue this month</p>
                <p className="stat-card-value">LKR {(stats.revenueThisMonth ?? 0).toLocaleString()}</p>
              </div>
              <div className="stat-card">
                <p className="stat-card-label">Pending invoices count</p>
                <p className="stat-card-value text-amber-600 dark:text-amber-400">{stats.pendingInvoices ?? 0}</p>
              </div>
            </div>
          </div>
