          ...
          <div key={serviceType.id} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50 p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="theme-text-primary font-semibold">LKR {serviceType.basePriceLKR.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="theme-text-muted">Duration:</span>
                <span className="theme-text-primary font-medium">{serviceType.estimatedDurationMinutes} min</span>
              </div>
            </div>
          </div>
        ))}
